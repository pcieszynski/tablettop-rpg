 ...
 */
@Mapper(componentModel = "spring", uses = {SkillMapper.class, GameMapper.class, StatusMapper.class, ItemMapper.class, ProfessionMapper.class, HelmetMapper.class, ArmourMapper.class, BootsMapper.class, GlovesMapper.class, LegsMapper.class, RightHandMapper.class, LeftHandMapper.class})
