...
public class SkillResourceIntTest {
    ...
    public void createSkill() throws Exception {
        ...
        assertThat(testSkill.getDamage()).isEqualTo(DEFAULT_DAMAGE);
        assertThat(testSkill.getHeal()).isEqualTo(DEFAULT_HEAL);
    ...
    public void updateSkill() throws Exception {
        ...
        assertThat(testSkill.getDamage()).isEqualTo(UPDATED_DAMAGE);
        assertThat(testSkill.getHeal()).isEqualTo(UPDATED_HEAL);
